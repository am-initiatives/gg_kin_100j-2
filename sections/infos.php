	...
	<section>
		...
		<div class="row row-infos">
			...
			<div class="col-md-offset-2 col-md-4">
				...
				<p class="note">Paiement par CB ou espèces.<br />Préventes disponibles sur <a href="https://www.weezevent.com/nuitdes100jours2017" target="_blank">Weezevent</a> et à partir du Lundi 15 Mai à la résidence des <i>Arts & Métiers</i> de 18h à 20h.</p>
			</div>
		</div>
		<div class="row row-infos">
			<div class="col-md-6">
			...
			<div class="col-md-offset-1 col-md-4 plusbas">
				...
				<p>
				Robe de soirée pour <strong>Madame</strong> &
				Costume cravate ou noeud papillon pour <strong>Monsieur</strong><br />
				<span style="font-size:12px">Des vestiaires seront mis à disposition gratuitement durant le Gala.</span></p>
			</div>
		</div>
